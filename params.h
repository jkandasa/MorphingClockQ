...
char wifi_ssid[] = "jee-esp";        //SSID
char wifi_pass[] = "secretpassword";        //Password

//Time settings
char timezone[] = "5" ;        // Timezone
char timezone_offset[] = "30" ;  // Timezone offset 
char military[] = "N";          // 24 hour mode? Y/N
char date_fmt[] = "D.M.Y";      // date format: D.M.Y or M.D.Y or M.D or D.M or D/M/Y
char dst_sav[] = "false";        // Daylight savings time

// RGB Maxtix settings
char c_palet[] = "1";      //Color palette
char brightness[] = "60";  //Brightness  (Don't go over 70)
char brightness_night[] = "5";  //Brightness night  (Don't go over 70)

char nightStart[] = "22";    //Set the hour using 24 hr format for the brightness to dim mode
char nightEnd[] = "6";       //set the hour using 24 hr format for returning clock to daytime brightness
...
char latitude[]       = "13.1258913";          //Some weather services require latitude
char longitude[]      = "80.1922268";          //Some weather services require longitude

char u_metric[] = "Y";              // Use Farenheit or Celcius for temp/wind
